...
export const getAppConfig = () => ({
  nodeEnv: process.env.AUTH_SERVICE_NODE_ENV || NodeEnv.Local,
  appName: process.env.AUTH_SERVICE_APP_NAME,
  appPort: +process.env.AUTH_SERVICE_APP_PORT || 3301,
  isProductionEnv: process.env.AUTH_SERVICE_NODE_ENV === NodeEnv.Production,
  frontendUrl: process.env.AUTH_SERVICE_FRONTEND_URL,
  queueDashboardPassword:
    process.env.AUTH_SERVICE_QUEUE_DASHBOARD_PASSWORD ||
